      ...
      <div className="w-full max-w-sm text-center">
        ...
        <form action="/pending-approval" method="get">
          <button
            ...
            type="submit"
            className="w-full h-11 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-zinc-300 text-sm font-medium rounded-xl transition-colors duration-150"
          >
            승인 상태 새로고침
          </button>
        </form>
